...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        type=str,
        default="logs",
        help="directory for logs, configs and checkpoints",
    )
    parser.add_argument(
        "-d",
        "--debug",
...
if __name__ == "__main__":
    ...
    if invalid:
        parser.error(
            ...
            "key=value, for example data.params.num_workers=4".format(" ".join(invalid))
        )
    ...
    try:
        ...
        # Lightning 1.4 moved the checkpoint callback into the `callbacks` list.
